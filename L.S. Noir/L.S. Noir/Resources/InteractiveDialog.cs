...
namespace LSNoir.Resources
{
    public class InteractiveDialogLine
    {
        ...
        public InteractiveDialogLine() { }

        public InteractiveDialogLine(int pedId, string txt)
        {
            PedId = pedId;
            Text = txt;
        }
    ...
    {
        public InteractiveDialogLine[] Lines { get; }
        ...
        public List<string> Dialogue { get; } = new List<string>();
        ...
        public InteractiveDialog(InteractiveDialogLine[] dialog, Vector3 pos, float stopDistance = 2f)
        {
            Lines = dialog;
            Position = pos;
        ...
        public void AddPed(int id, Ped p) => _pedDictionary.Add(id, p);
        ...
        {
            var pedList = new List<Ped>(_pedDictionary.Values);
        ...
        {
            return _pedDictionary[Lines[line].PedId];
        }
