    ...
    class ConversationCreator
    {
        ...
        public static DialogLine[] DialogLineCreator(ConversationType type, Ped ped, int witnumber = 0, bool victimAlive = false, PedData vicdata = null, PedData susdata = null, PedData witdata = null)
        {
            ...
            if (type == ConversationType.Fo)
            {
                ...
                DialogLine line1 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line2 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line3 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line4 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line5 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line6 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
                ...
                DialogLine line7 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                value.Clear();
            ...
            else if (type == ConversationType.Ems)
            {
                ...
                if (victimAlive)
                {
                    ...
                    line2 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
                    ...
                    line3 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
                    ...
                    line4 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
                }
                else
                {
            ...
            else if (type == ConversationType.Witness)
            {
                ...
                if (witdata != null)
                {
                    ...
                    line5 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
                    ...
                    line6 = new DialogLine(1, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
                    ...
                    line7 = new DialogLine(0, value[Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, value.Count)]);
                    value.Clear();
            ...
            else if (type == ConversationType.Physician)
            {
                ...
                if (important)
                {
                    if (traces == (Traces.Blood | Traces.Semen | Traces.Hair | Traces.Saliva | Traces.Wearer | Traces.Urine))
                    {
                        ...
                        chance = Fiskey111Common.RandomNumberGenerator.RandomNumber().Next(1, 101);
            ...
            else if (type == ConversationType.MedicalExaminer)
            {
                ...
                {
                    value.Add("[~g~" + fullName + "~w~] Ummm... I've had so many cases today let me think. Right, " + vicdata.Name + ". We didn't find anything at all, sorry.");
                    value.Add("[~g~" + fullName + "~w~] Oh right, they were a terrible case. We actually didn't find anything besided the fact they were strangled, sorry about that!");
                    value.Add("[~g~" + fullName + "~w~] Yes, I remember. There wasn't anything we could find from them. I hope you have something else you can use to catch the suspect.");
