    ...
    class ConversationCreator
    {
        ...
        public static DialogLine[] DialogLineCreator(ConversationType type, Ped ped, int witnumber = 0, bool victimAlive = false, PedData vicdata = null, PedData susdata = null, PedData witdata = null)
        {
            ...
            if (type == ConversationType.Fo)
            {
                ...
                DialogLine line1 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line2 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line3 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line4 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line5 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line6 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
                ...
                DialogLine line7 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                value.Clear();
            ...
            else if (type == ConversationType.Ems)
            {
                ...
                if (victimAlive)
                {
                    ...
                    line2 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                    ...
                    line3 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                    ...
                    line4 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                }
                else
                {
            ...
            else if (type == ConversationType.Witness)
            {
                ...
                if (witdata != null)
                {
                    ...
                    line5 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                    ...
                    line6 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                    ...
                    line7 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
            ...
            else if (type == ConversationType.MedicalExaminer)
            {
                ...
                if (important)
                {
                    ...
                    line3 = new DialogLine(1, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                    ...
                    line4 = new DialogLine(0, value[Random.RandomInt(0, value.Count)]);
                    value.Clear();
                }
                else
                {
                    var cod = Random.RandomInt(0, 1) == 1 ? "Strangulation" : "Asphyxiation";
